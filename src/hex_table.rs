// TODO: Benchmark this against string formatting... {:02X}
const HEX_TABLE_UPPER: [&str; 256] = [
...
pub const fn u8_to_upper_hex(value: u8) -> &'static str {
    HEX_TABLE_UPPER[value as usize]
}
pub const fn u8_to_lower_hex(value: u8) -> &'static str {
